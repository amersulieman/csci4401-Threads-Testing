...
class ThreadsDesign extends Thread {
    ...
    public void run(){
        ...
        while(!(rowsQueue.isEmpty() && columnsQueue.isEmpty())) {
            ...
            System.out.printf("I am thread %d Processing result array[%d][%d]\n",(thread_Id+1),rowSpot,columnSpot);
            ...
            for (int iterator = 0; iterator < numberOfElementsToMultiply; iterator++) {
                ...
                System.out.printf(" Thread %d Processing ... Matrix1[%d][%d] * matrix2[%d][%d] = %f \n",thread_Id+1,rowSpot,iterator,iterator,columnSpot,(matrix1[rowSpot][iterator] * matrix2[iterator][columnSpot]));
            }
